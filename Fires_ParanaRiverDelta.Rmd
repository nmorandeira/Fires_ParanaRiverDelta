...
```{r read_file}
library(sf)
hotspots_all <- st_read("data/hotspots/focos_all_20200806.shp", quiet=TRUE) 
...
ggsave("Focos_acumulados_2020_sinfoto_actualizado_2020-08-06.png", plot = p2, width = 8, height = 5, dpi = 300)
ggsave("Focos_20200806_daily.png", plot = p2b, width = 8, height = 5, dpi = 300)
...
p3 <- focos_cum %>%
  ...
  labs(title="Potential fires at the Paraná River Delta (Argentina)", subtitle = "Daily hotspots and cummulative numbers, based on VIIRS data - FIRMS-NASA", caption = "Patricia Kandus, Natalia Morandeira and Priscilla Minotti; 3iA-UNSAM")  

p3

ggsave("Focos_acumulados_2020_sinfoto_actualizado_2020-08_06_english.png", plot = p3, width = 8, height = 5, dpi = 300)
