...
```{r grabar}
ggsave("output/Focos_acumulados_2020-10-04.png", plot = plot_cum, width = 8, height = 5, dpi = 300)
ggsave("output/Focos_diario_2020-10-04.png", plot = plot_daily, width = 8, height = 5, dpi = 300)
```
...
ggsave("output/MODIS_2001-2020.png", plot = p0, width = 8, height = 5, dpi = 300)
...
ggsave("output/VIIRS_2012-2020.png", plot = p0, width = 8, height = 5, dpi = 300)
...
p3 <- ggplot(focos_VIIRS2020_mes, aes(x=mes, y=cantidad_mes)) +
  geom_col( fill="lightblue") +
...
ggsave("output/Focos_VIIRS2020_mensual.png", plot = p3, width = 8, height = 5, dpi = 300)
