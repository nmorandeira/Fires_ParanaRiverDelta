...
```{r read_file}
library(sf)
hotspots_all <- st_read("data/hotspots/focos_all_20200901.shp", quiet=TRUE) 
...
```{r grabar}
ggsave("output/Focos_acumulados_2020-09-01.png", plot = plot_cum, width = 8, height = 5, dpi = 300)
ggsave("output/Focos_diario_2020-09-01.png", plot = plot_daily, width = 8, height = 5, dpi = 300)
```
...
```{r save}
ggsave("output/Hotspot_cum_2020-09-01.png", plot = plot_cum_eng, width = 8, height = 5, dpi = 300)
ggsave("output/Hotspot_daily_2020-09-01.png", plot = plot_daily_eng, width = 8, height = 5, dpi = 300)
```
