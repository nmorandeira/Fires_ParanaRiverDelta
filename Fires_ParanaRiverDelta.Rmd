...
library(sf)
hotspots_all <- st_read("data/hotspots/focos_all_20200410.shp", quiet=TRUE) 
...
The cummulative number of MODIS hotspots during 2020 is **`r MODIS_2020`** up to **`r last_date`**, which is **`round(MODIS_2020/MODIS_2008*100,1)`%** of the MODIS hotspots recorded during 2008. 
